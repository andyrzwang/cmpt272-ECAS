...
function Map({ setSidebar }) {
  ...
  <div style="font-family: 'Arial', sans-serif; color: #333; padding: 10px; max-width: 250px;">
    ...
    <p style="margin: 8px 0; font-size: 14px;"><strong style="color: #333;">Time:</strong> ${report.submissionTime}</p>
    <p style="margin: 8px 0; font-size: 14px;"><strong style="color: #333;">Location:</strong> ${report.location}</p>
    <p style="margin: 8px 0; font-size: 14px;"><strong style="color: #333;">Incident Type:</strong> ${report["emergency-type"]}</p>
    <div style="margin-top: 10px; text-align: center;">
      <img src="${report.image}" alt="No Image Provided" style="max-width: 100%; height: auto; border-radius: 4px;">
    </div>
  </div>
`;
